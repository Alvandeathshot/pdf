...
export const APP_DEFAULT_PATH = '/dashboard/dash';
...
export let LoginLayoutType;

(function (LoginLayoutType) {
  LoginLayoutType['SIMPLE'] = 'simple';
  LoginLayoutType['LANDING'] = 'landing';
