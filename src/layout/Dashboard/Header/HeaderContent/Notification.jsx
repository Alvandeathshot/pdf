...
export default function NotificationPage() {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, message: "Welcome To Dyadic Health.", time: "2 min ago", read: false, icon: <Gift size={20} variant="Bold" />, timeStamp: "3:00 AM" },
    { id: 2, message: "Aida Burg commented your post.", time: "5 August", read: false, icon: <MessageText1 size={20} variant="Bold" />, timeStamp: "6:00 PM" },
    { id: 3, message: "Your Profile is Complete 60%.", time: "7 hours ago", read: true, icon: <Setting2 size={20} variant="Bold" />, timeStamp: "2:45 PM" },
    { id: 4, message: "Cristina Danny invited you to join Meeting.", time: "Daily scrum meeting time", read: true, icon: <Avatar type="combined">C</Avatar>, timeStamp: "9:10 PM" }
  ]);
            ...
            >
              <ClickAwayListener onClickAway={handleClose}>
                <MainCard elevation={0} border={false}>
                  <Stack direction="row" alignItems="center" justifyContent="space-between">
                    <Typography variant="h5">Notifications</Typography>
                    <Link href="#" variant="h6" color="primary" onClick={handleMarkAllAsRead}>
                      Mark all read
                    </Link>
                  </Stack>
                  <List
                      ...
                      <ListItemButton
                        ...
                        sx={{
                          backgroundColor: notification.read
                            ? 'transparent'
                            : theme.palette.action.hover, // Unread notifications get a different background
                          '&:hover': {
                            backgroundColor: notification.read
                              ? 'transparent'
                              : theme.palette.action.selected // On hover, the background changes
                          }
                        }}
                      >
                        <ListItemAvatar>
                          ...
                          primary={
                            <Typography
                              ...
                              sx={{
                                ...
                                color: notification.read ? 'text.secondary' : 'text.primary' // Change text color
                              }}
                            >
