      ...
      children: [
        {
          ...
          type: 'item',
          link: '/hello/profiles/user/:tab',
          url: '/hello/profiles/user/personal',
          breadcrumbs: false
        },
        {
          id: 'account-profile',
          ...
          type: 'item',
          url: '/hello/profiles/account/basic',
          link: '/hello/profiles/account/:tab',
          breadcrumbs: false
        }
      ]
    },
      ...
      children: [
        {
          ...
          type: 'item',
          url: '/hello/e-commerce/products'
        },
        {
          id: 'product-details',
          title: <FormattedMessage id="product-details" />,
          type: 'item',
          link: '/hello/e-commerce/product-details/:id',
          url: '/hello/e-commerce/product-details/1',
          breadcrumbs: false
        },
        {
          id: 'product-list',
          ...
          type: 'item',
          url: '/hello/e-commerce/product-list',
          breadcrumbs: false
        },
        {
          id: 'add-new-product',
          ...
          type: 'item',
          url: '/hello/e-commerce/add-new-product'
        },
        {
          id: 'checkout',
          title: <FormattedMessage id="checkout" />,
          type: 'item',
          url: '/hello/e-commerce/checkout'
        }
      ]
    }
  ]
