...
import LoginLayout from 'layout/logged';
...
// render - features
const FeatureInsights = Loadable(lazy(() => import('pages/features/insights')));
const FeatureArticles = Loadable(lazy(() => import('pages/features/articles')));
const FeatureAssessments = Loadable(lazy(() => import('sections/extra-pages/preassessment/exercise')));

// render - dyadicprofiles
const DyadicProfiles = Loadable(lazy(() => import('sections/profile/DyadContainers')));
...
//const AddDyad = Loadable(lazy(() => import('sections/apps/profiles/account/addDyad')));
...
const ProfileCompletionPage = Loadable(lazy(() => import('sections/apps/profiles/account/ProfileCompletionPage'))); // Add the correct path
...
const Introduction = Loadable(lazy(() => import('pages/offerings/introduction')));
const Recovery = Loadable(lazy(() => import('pages/offerings/recovery')));
const Discussion = Loadable(lazy(() => import('pages/dashboard/discussion')));
const Articles = Loadable(lazy(() => import('pages/offerings/Articles')));
const ArticleDetail = lazy(() => import('sections/extra-pages/Articles/ArticleDetails'));
const Resources = Loadable(lazy(() => import('pages/offerings/Resources')));
const Foundation = Loadable(lazy(() => import('pages/offerings/Breathing')));
const Posture = Loadable(lazy(() => import('pages/offerings/posture')));
const Diet = Loadable(lazy(() => import('pages/offerings/diet')));
const Workout = Loadable(lazy(() => import('pages/offerings/workout')));
const Verification = Loadable(lazy(() => import('pages/verification')));
const Training = Loadable(lazy(() => import('pages/offerings/Training')));
const Video = Loadable(lazy(() => import('pages/video')));
const Combo = Loadable(lazy(() => import('../sections/extra-pages/video/videosection')));
const NewDashboard = Loadable(lazy(() => import('pages/profile/new')));
const Profilemain = Loadable(lazy(() => import('pages/profile/profilemainpage')));
const TokenPage = Loadable(lazy(() => import('sections/auth/Token.jsx')));
const Intropuction = Loadable(lazy(() => import('pages/Introduction')));
...
const MainRoutes = {
  ...
  children: [
      ...
      children: [
...

        {
          ...
          children: [
            {
              path: 'insights',
              element: <FeatureInsights />
            },
            {
              path: 'articles',
              element: <FeatureArticles />
            },
            {
              path: 'assessments',
              element: <FeatureAssessments />
            }
          ]
        },
    ...
    {
      path: '/hello',
      element: <LoginLayout layout={LoginLayoutType.SIMPLE} />,
      children: [
        ...
        {
          path: 'articles/:id', // Dynamic route for individual article details
          element: <ArticleDetail />
              
        },
        {
          path: 'token', // Dynamic route for individual article details
          element: 
              <TokenPage />
        },
        {
        ...
        {
          path: 'posture', // Add this line
          element: <Posture /> // Add this line
        },
        {
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'diet', // Add this line
          element: <Diet /> // Add this line
        },
        {
          path: 'workout', // Add this line
          element: <Workout /> // Add this line
        },
        {
          path: 'Training', // Add this line
          element: <Training /> // Add this line
        ...
        {
          path: 'Introduction',
          element: <Introduction/>  // Use <Video /> if you're keeping the file named Video.jsx
        },
        {
          path: 'Recovery',
          element: <Recovery />  // Use <Video /> if you're keeping the file named Video.jsx
        },
        {
          path: 'Discussion',
          element: <Discussion />
        ...
        {
          path: '/combo',
          element: <MaintenanceError /> // Fallback 404 page
        },
        // {
        //   path: 'default',
        //   element: <DashboardDefault />
