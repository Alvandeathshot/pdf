...
export default function DetailForm({ onSubmitSuccess }) {
    ...
    if (!emailError && email && !nameError && firstName && lastName) {
      try {
        ...
        if (response.ok) {
          ...
          setSubmitError(null);
          onSubmitSuccess(); // Trigger the callback when successful
        } else {
  ...
  return (
    <Container>
      <Grid container spacing={3} alignItems="center" justifyContent="center" sx={{ mt: 2.5, mb: 2.5 }}>
